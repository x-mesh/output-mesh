...
(() => {
  ...
  const MESSAGES = {
    ko: {
      ...
      'changes.outside': '에이전트 밖에서',
      'changes.outsideTitle': '에이전트 기록이 아니라 파일을 다시 확인하다 알게 된 변화입니다',
    ...
    en: {
      ...
      'changes.outside': 'outside an agent',
      'changes.outsideTitle': 'Noticed by re-checking the file on disk, not from an agent’s log',
