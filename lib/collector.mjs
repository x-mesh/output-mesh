...
import { BUILD_ARTIFACT_DIRS, COLLECT_YIELD_MS, FEED_BACKLOG_S, MAX_BUNDLE_MEMBERS, PROJECT_MARKERS, SESSION_TITLE_MAX_CHARS, WORKSPACE_SCAN_MAX_DEPTH, WORKSPACE_SCAN_MAX_FILES, nfc } from './paths.mjs';
